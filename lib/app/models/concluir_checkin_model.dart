class CheckInResponse {
  ConcluirCheckin data;
  List<String> errors;

  CheckInResponse({required this.data, required this.errors});

  factory CheckInResponse.fromJson(Map<String, dynamic> json) {
    return CheckInResponse(
      data: ConcluirCheckin.fromJson(json['data']),
      errors: List<String>.from(json['errors']),
    );
  }
}

class ConcluirCheckin {
  int id;
